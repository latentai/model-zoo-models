...
```
1. ./dev_docker_run python prepate_eval_data.py --path_to_settings settings/local.yaml --model_checkpoints  saved_models/tf/
...
### Compress
```    
./dev_docker_run leip compress --input_path saved_models/tf/ --output_path saved_models/compressed_tf/ --quantizer asymmetric
```
