...
./dev_docker_run ./train.py --dataset_path datasets/open-images-10-classes/train/  --eval_dataset_path datasets/open-images-10-classes/eval/ --epochs 48
...
dev-leip-run leip evaluate -fw tf --input_path checkpoint/ --test_path=datasets/open-images-10-classes/eval/index.txt --class_names=class_names.txt --task=classifier --dataset=custom  --preprocessor imagenet_caffe
